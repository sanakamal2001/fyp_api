...
def DASlabel(query):
  ...
  print(depressed,anxious,stressed)
  mentalstate={"D":depressed,"A":anxious,"S":stressed}
  label=" "
  ...
  percent=[]
  level=""
  if 1 in mentalstate.values():
    if mentalstate["D"]==1:
      if(dv>98.5):
        mentalstate["D"]="moderately severe"
      else:
        mentalstate["D"]="moderate"  
    if mentalstate["A"]==1:
      if(av>98.5):
        mentalstate["A"]="moderately severe"
      else:
        mentalstate["A"]="moderate"
    if mentalstate["S"]==1:
      if(sv>98.5):
        mentalstate["S"]="moderately severe"
      else:
        mentalstate["S"]="moderate" 
  else:
    mentalstate["S"]=sv
    mentalstate["D"]=dv
    mentalstate["A"]=av
    key=max(mentalstate,key=mentalstate.get)
    mentalstate["S"],mentalstate["D"],mentalstate["A"]=0,0,0
    mentalstate[key]="minor"
  mentalstate={key: value for key, value in mentalstate.items() if isinstance(value, str)}
  return mentalstate  
